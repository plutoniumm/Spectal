...
<header id="purecss_header" class="header fixed">
  <a href="./index.html" class="logo">
    <img src={logo} width="100px" height="auto" alt="Spectal" />
  </a>
  ...
  <ul class="menu">
    ...
    <li class="socials">
      <a href={socials.fb} style="display:inline-block"><svg
      ...
      <a href={socials.ig} style="display:inline-block">
      ...
      <a href={socials.tw} style="display:inline-block">
      ...
      <a href={socials.in} style="display:inline-block"><svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href={socials.wa} style="display:inline-block"><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"><path
